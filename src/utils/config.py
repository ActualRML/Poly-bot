...
class Config:
    ...
    UPDOWN_HOURLY_MOMENTUM_MIN        : float = _get_float("UPDOWN_HOURLY_MOMENTUM_MIN", 0.0005)
    UPDOWN_HOURLY_MOMENTUM_VOL_FACTOR : float = _get_float("UPDOWN_HOURLY_MOMENTUM_VOL_FACTOR", 0.34)
    ...
    UPDOWN_HOURLY_LOCK_ANYTIME_PCT    : float = _get_float("UPDOWN_HOURLY_LOCK_ANYTIME_PCT", 150.0)
    ...
    EV_GATE_MIN_MARGIN                : float = _get_float("EV_GATE_MIN_MARGIN", -0.05)
