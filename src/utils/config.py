...
class Config:
    ...
    UPDOWN_HOURLY_GBM_MIN_EDGE        : float = _get_float("UPDOWN_HOURLY_GBM_MIN_EDGE", 0.03)
    UPDOWN_HOURLY_GBM_MAX_EDGE        : float = _get_float("UPDOWN_HOURLY_GBM_MAX_EDGE", 0.15)
    UPDOWN_GBM_MAX_STRIKE_DRIFT       : float = _get_float("UPDOWN_GBM_MAX_STRIKE_DRIFT", 0.04)
    ...
    UPDOWN_HOURLY_CONSENSUS_FLOOR     : float = _get_float("UPDOWN_HOURLY_CONSENSUS_FLOOR", 0.90)

    UPDOWN_HOURLY_USE_TECHNICAL       : bool  = _get_bool("UPDOWN_HOURLY_USE_TECHNICAL", False)
    UPDOWN_HOURLY_RSI_PERIOD          : int   = _get_int("UPDOWN_HOURLY_RSI_PERIOD", 14)
    UPDOWN_HOURLY_RSI_OVERBOUGHT      : float = _get_float("UPDOWN_HOURLY_RSI_OVERBOUGHT", 70.0)
    UPDOWN_HOURLY_RSI_OVERSOLD        : float = _get_float("UPDOWN_HOURLY_RSI_OVERSOLD", 30.0)
    UPDOWN_HOURLY_RSI_MOM_OB          : float = _get_float("UPDOWN_HOURLY_RSI_MOM_OB", 68.0)
    UPDOWN_HOURLY_RSI_MOM_OS          : float = _get_float("UPDOWN_HOURLY_RSI_MOM_OS", 35.0)
    UPDOWN_HOURLY_ZSCORE_WINDOW       : int   = _get_int("UPDOWN_HOURLY_ZSCORE_WINDOW", 20)
    UPDOWN_HOURLY_ZSCORE_THR          : float = _get_float("UPDOWN_HOURLY_ZSCORE_THR", 2.5)
    UPDOWN_HOURLY_ZSCORE_MOM_THR      : float = _get_float("UPDOWN_HOURLY_ZSCORE_MOM_THR", 2.0)
    UPDOWN_HOURLY_VOL_SPIKE_MULT      : float = _get_float("UPDOWN_HOURLY_VOL_SPIKE_MULT", 3.0)
    UPDOWN_HOURLY_BTC_CORR_THR        : float = _get_float("UPDOWN_HOURLY_BTC_CORR_THR", 0.005)
    UPDOWN_HOURLY_MIN_VOL_RATIO       : float = _get_float("UPDOWN_HOURLY_MIN_VOL_RATIO", 0.5)
    UPDOWN_GBM_VOL_EDGE_FACTOR        : float = _get_float("UPDOWN_GBM_VOL_EDGE_FACTOR", 0.05)
    UPDOWN_GBM_VOL_EDGE_CAP           : float = _get_float("UPDOWN_GBM_VOL_EDGE_CAP", 0.05)
    UPDOWN_GBM_REGIME_SURCHARGE_ENABLED: bool = _get_bool("UPDOWN_GBM_REGIME_SURCHARGE_ENABLED", True)
    UPDOWN_GBM_REGIME_SURCHARGE       : float = _get_float("UPDOWN_GBM_REGIME_SURCHARGE", 0.07)
    CANDLE_UPDOWN_MOM_VOL_FACTOR      : float = _get_float("CANDLE_UPDOWN_MOM_VOL_FACTOR", 0.003)
    HOURLY_LOCK_T1_PCT                : float = _get_float("HOURLY_LOCK_T1_PCT", 150.0)
    HOURLY_LOCK_T2_PCT                : float = _get_float("HOURLY_LOCK_T2_PCT", 100.0)
    UPDOWN_HOURLY_MACRO_TREND_GATE    : bool  = _get_bool("UPDOWN_HOURLY_MACRO_TREND_GATE", True)
    UPDOWN_HOURLY_MACRO_TREND_THR     : float = _get_float("UPDOWN_HOURLY_MACRO_TREND_THR", 0.02)
    UPDOWN_HOURLY_MACRO_TREND_HOURS   : int   = _get_int("UPDOWN_HOURLY_MACRO_TREND_HOURS", 4)
