...
class Config:
    ...
    MAX_SAME_DIRECTION     : int   = _get_int("MAX_SAME_DIRECTION", 0)
    ...
    MAX_POSITIONS_PER_SLOT            : int   = _get_int("MAX_POSITIONS_PER_SLOT", 0)
    UPDOWN_HOURLY_MOMENTUM_MINUTES    : int   = _get_int("UPDOWN_HOURLY_MOMENTUM_MINUTES", 15)
    UPDOWN_HOURLY_MOMENTUM_THRESHOLD  : float = _get_float("UPDOWN_HOURLY_MOMENTUM_THRESHOLD", 0.003)
    UPDOWN_HOURLY_MAX_ENTRY_PRICE     : float = _get_float("UPDOWN_HOURLY_MAX_ENTRY_PRICE", 0.50)
