...
class Config:
    ...
    UPDOWN_HOURLY_GBM_MAX_EDGE        : float = _get_float("UPDOWN_HOURLY_GBM_MAX_EDGE", 0.25)
    ...
    UPDOWN_HOURLY_MIN_VOL_RATIO       : float = _get_float("UPDOWN_HOURLY_MIN_VOL_RATIO", 0.7)
    UPDOWN_GBM_VOL_EDGE_FACTOR        : float = _get_float("UPDOWN_GBM_VOL_EDGE_FACTOR", 0.10)
    ...
    UPDOWN_HOURLY_MAX_ENTRIES_PER_SLOT: int   = _get_int("UPDOWN_HOURLY_MAX_ENTRIES_PER_SLOT", 5)
